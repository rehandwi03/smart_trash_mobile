...
class MqttHandler with ChangeNotifier {
  ...
  Future<Object> connect(String topic) async {
    client = MqttServerClient.withPort('192.168.0.120', '', 1883);
    ...
    client.updates!.listen((List<MqttReceivedMessage<MqttMessage?>>? c) {
      ...
      final jsonData = jsonDecode(message.payload.message.toString());

      final monitorData = TrashMonitor.fromJson(jsonData);

      data.value = monitorData.data;
      notifyListeners();
      // print(
